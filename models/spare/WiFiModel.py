...
class WiFiModel(BasicModel):
    def __init__(self, num_classes=300, in_channels=150):
        ...
        self.UNet = UNet(self.num_classes, self.in_channels, depth=5)
        # self.UNet2 = UNet(self.num_classes, self.in_channels, depth=5)
        self.downsample = nn.AdaptiveAvgPool2d((46, 82))
        self.fullconv_1 = nn.Sequential(
            nn.Conv2d(300, 52, 3, 1, 1),
            nn.BatchNorm2d(52),
            nn.ReLU(inplace=True),
            nn.Conv2d(52, 26, 1, 1),
            nn.BatchNorm2d(26),
