...
def image_mask(image):
    parser = argparse.ArgumentParser(description="PyTorch Object Detection Video")
    parser.add_argument(
        "--config-file",
        default="lib/maskrcnn-benchmark/configs/caffe2/e2e_mask_rcnn_R_50_FPN_1x_caffe2.yaml",
        metavar="FILE",
